class VolunContactsController < ApplicationController

  load_and_authorize_resource
  respond_to :html, :js, :json

  def index
    params[:q] ||= VolunContact.ransack_default
  ...
  def new
    @volun_contact = VolunContact.new
  ...
  protected
    ...
    def volun_contact_params
      params.require(:volun_contact).permit(:volunteer_id, :project_id, :technician_id, :contact_date, :contact_result_id, :comments)
    end
end
