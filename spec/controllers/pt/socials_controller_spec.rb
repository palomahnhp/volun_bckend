...
RSpec.describe Pt::SocialsController, type: :controller do
  ...
  describe "GET #index" do
    it 'assigns all pt_socials as @pt_socials' do
      social = Pt::Social.create! valid_attributes
      get :index
  ...
  describe "POST #create" do
    ...
    context 'with invalid params' do
      it 'assigns a newly created but unsaved pt_social as @pt_social' do
        post :create, pt_social: invalid_attributes
        expect(assigns(:pt_social)).to be_a_new(Pt::Social)
      end
  ...
  describe "PUT #update" do
    context 'with valid params' do
      ...
      it 'updates the requested pt_social' do
        social = Pt::Social.create! valid_attributes
        put :update, id: social.to_param, pt_social: new_attributes
        social.reload
  ...
  describe "DELETE #destroy" do
    it 'destroys the requested pt_social' do
      ...
      }.to change(Pt::Social, :count).by(social.respond_to?(:archived?) ? 0 : -1)
    end
